...
int main(void)
{
	...
	{
		printf("\x1b[39m\x1b[2;7H Inicializando...");
		retardo(5);
		inicializa_matriz(matrix, level);
		escribe_matriz_debug(matrix);
		printf("\x1b[2;2H                        ");
		retardo(5);
		recombina_elementos(matrix);	//llamar función de recombinar
		printf("\x1b[39m\x1b[2;7H Recombinando...");
		retardo(10);
		printf("\x1b[2;2H                        ");
		escribe_matriz_debug(matrix);
		retardo(2);
		...
		printf("\x1b[39m\x1b[2;5H Matriz Recombinado");
		do
		{	swiWaitForVBlank();
