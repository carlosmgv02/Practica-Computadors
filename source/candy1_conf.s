...
@;		16+:	gelatina doble (a sumarle c�digo de elemento)
	...
	@; mapa 0: todo aleatorio
		.byte 2,9,17,2,1,3,4,1,4
		.byte 1,3,4,1,6,9,17,2,9
		.byte 10,7,7,7,7,7,16,3,17
		.byte 18,7,6,2,2,5,16,1,5
		.byte 3,7,5,3,13,7,7,7,7
		.byte 2,7,14,10,21,2,2,6,7
		.byte 6,4,22,18,2,5,10,0,7
		.byte 4,14,7,7,7,7,0,14,7
		.byte 6,4,22,16,16,16,18,22,7
	...
	@; mapa 9: hay combinacion
		.byte 3,3,2,15,15,15,15,15,15
		.byte 15,15,3,15,15,15,15,15,2
		.byte 1,2,3,3,7,3,15,15,2
		.byte 1,2,7,5,3,7,15,2,7
		.byte 7,1,1,2,3,9,15,15,15
		.byte 1,4,20,10,9,6,15,15,15
		.byte 6,18,7,4,6,2,2,4,2
		.byte 12,5,4,3,11,5,15,15,15
		.byte 7,7,4,19,4,6,15,15,15
	@; mapa 10: hay combinacion
		/*.byte 3,3,2,15,15,15,15,15,15
		.byte 15,15,2,15,15,15,15,15,2
		.byte 1,2,3,3,7,3,15,15,2
		.byte 1,2,7,5,3,7,15,7,7
		.byte 7,1,1,2,3,9,15,15,15
		.byte 1,4,20,10,9,6,15,15,15
		.byte 6,18,7,4,6,2,2,4,2
		.byte 12,5,4,3,11,5,15,15,15
